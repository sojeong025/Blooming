  ...
  return (
    <div className={classes.container} style={{ marginTop: '70px' }}>
      ...
      <div className={classes.themeSelection}>
        ...
        <input type="radio" id="theme1" name="theme" value={1} checked={theme === 1} onChange={handleThemeButtonClick} />
          테마 1
        </label>
        <label className={classes.radio} htmlFor="theme2">
        <input type="radio" id="theme2" name="theme" value={2} onChange={handleThemeButtonClick} />
          테마 2
        </label>
        <label className={classes.radio} htmlFor="theme3">
        <input type="radio" id="theme3" name="theme" value={3} onChange={handleThemeButtonClick} />
          테마 3
        </label>
        <label className={classes.radio} htmlFor="theme4">
        <input type="radio" id="theme4" name="theme" value={4} onChange={handleThemeButtonClick} />
          테마 4
        </label>
      </div>

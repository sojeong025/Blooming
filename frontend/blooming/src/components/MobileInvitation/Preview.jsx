...
function Preview({
  ...
  function renderMainTheme1() {
    return (
      <div className={`${themeStyles.main}`}>
        ...
        <p className={`${themeStyles.mainDday}`}>
          {dday ? "D-" + dday : "D-Day"}
        </p>
        <img
          src={
            invitationData.thumbnail
              ? invitationData.thumbnail
              : "/src/assets/Character/main.jpeg"
          }
          alt='thumbnail'
        />
        <p className={`${themeStyles.mainName}`}>
          {invitationData.groomName ? invitationData.groomName : "신랑"}{" "}
          <span style={{ fontSize: "15px" }}>그리고</span>{" "}
          {invitationData.brideName ? invitationData.brideName : "신부"}
        </p>
        <p className={`${themeStyles.mainWedding}`}>
          {invitationData.date ? invitationData.date : "예식일"} <br />
  ...
  function renderMainTheme2() {
    return (
      <div className={`${themeStyles.main}`}>
        <div className={`${themeStyles.mainName}`}>
          {invitationData.groomName ? invitationData.groomName : "신랑"} <br />
          <span style={{ fontSize: "15px" }}>그리고</span>
          <br />
          {invitationData.brideName ? invitationData.brideName : "신부"}
        </div>
        <img
          src={
            invitationData.thumbnail
              ? invitationData.thumbnail
              : "/src/assets/Couple/wedding3.jpg"
          }
          alt='thumbnail'
        />
        ...
        <div
          className={
            isDetailPage ? themeStyles.weddingDetail : themeStyles.wedding
          }
        >
          Wedding
        </div>
      ...
      <div className={`${themeStyles.main}`}>
        ...
        <img
          src={
            invitationData.thumbnail
              ? invitationData.thumbnail
              : "/src/assets/Couple/wedding4.jpg"
          }
          alt='thumbnail'
        />
  ...
  function renderMainTheme4() {
    const invitationDate = invitationData.date
      ? getMonthAndDate(invitationData.date)
      : null;
    return (
      <div className={`${themeStyles.main}`}>
        ...
        <img
          src={
            invitationData.thumbnail
              ? invitationData.thumbnail
              : "/src/assets/Couple/wedding2.jpg"
          }
          alt='thumbnail'
        />
        <div className={`${themeStyles.mainName}`}>
  ...
  return (
    <div className={classes.total} style={positionStyle}>
      ...
      <div
        ...
        style={{
          ...previewStyle,
          backgroundColor: themeColors[theme] || "rgb(250, 248, 246)",
        }}
      >
        {/* ---------메인-------- */}
        ...
        <div
          className={`${classes.mention} ${
            theme === 3 ? themeStyles.theme3Font : ""
          }`}
        >
          <p className={classes.mentionTitle}>
          ...
          <p className={classes.mentionContent}>
            {invitationData.content
              ? invitationData.content
              : "서로가 마주보며 다져온 사랑을 이제 함께 한 곳을 바라보며 걸어갈 수 있는 큰 사랑으로 키우고자 합니다. 저희 두 사람이 사랑의 이름으로 지켜나갈 수 있도록 앞날을 축복해 주시면 감사하겠습니다."}{" "}
          </p>
          <hr
            className={
              theme === 2
                ? themeStyles.mentionHrTheme2
                : theme === 4
                ? themeStyles.mentionHrTheme4
                : theme === 3
                ? themeStyles.mentionHrTheme3
                : ""
            }
          />
        </div>
        ...
        >
          <div className={classes.connectName}>
            <div>
              ...
              {invitationData.groomMotherName
                ? invitationData.groomMotherName
                : "신랑어머니"}{" "}
              <span style={{ fontSize: "15px" }}>의 아들</span>{" "}
              {invitationData.groomName ? invitationData.groomName : "신랑"}
            </div>{" "}
            <br />
            <div>
              ...
              {invitationData.brideMotherName
                ? invitationData.brideMotherName
                : "신부어머니"}{" "}
              <span style={{ fontSize: "15px" }}>의 딸</span>{" "}
              {invitationData.brideName ? invitationData.brideName : "신부"}
            </div>
            <div
              className={`${classes.connectImg} ${
                theme === 4
                  ? themeStyles.connectImgTheme4
                  : theme === 2
                  ? themeStyles.connectImgTheme2
                  : theme === 3
                  ? themeStyles.connectImgTheme3
                  : ""
              }`}
            >
              소중한 당신을 초대합니다
          ...
          <div className={classes.connectCouple}>
            <div className={classes.connectCall}>
              ...
              <div className={classes.connectIconGroom}>
            ...
            <div className={classes.connectCall}>
              ...
              <div className={classes.connectIconBrider}>
                <BsFillTelephoneFill size={20} />
              </div>
              <div className={classes.connectIcon}>
                <BiSolidMessageDots size={20} />
          ...
          <div className={classes.connectParent}>
            <div
              className={`${classes.connectParentImg} ${
                theme === 2
                  ? themeStyles.connectParentImg4
                  : theme === 3
                  ? themeStyles.connectParentImg3
                  : ""
              }`}
            >
              혼주에게 연락하기
